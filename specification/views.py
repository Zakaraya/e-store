...
from main.models import CategoryProduct, Product


class BaseSpecView(View):

    def get(self, request, *args, **kwargs):
        return render(request, 'specification/product_features.html', {})
...
class CreateNewFeature(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        context = {'form': form}
        return render(request, 'specification/new_feature.html', context)
...
class CreateNewCategory(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        context = {'form': form}
        return render(request, 'specification/new_category.html', context)

    def post(self, request, *args, **kwargs):
        form = NewCategoryForm(request.POST or None)
        if form.is_valid():
            new_category = form.save(commit=False)
            new_category.name = form.cleaned_data['category_name']
            new_category.save()
        return HttpResponseRedirect('/product-specs/')
...
class CreateNewFeatureValidator(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'specification/new_validator.html', context)
...
class FeatureChoiceView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        html_select = """<select class="form-select" name="feature-validators" id="feature-validators-id" 
        aria-label="Default select example"> <option selected>---</option> {result} </select> """
...
class CreateFeatureView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        print(value)
        category = CategoryProduct.objects.get(id=int(category_id))
        ...
        messages.add_message(
            ...
            f'"{feature.feature_name}" в категории {category.category_name} успешно создано'
        )
...
class NewProductFeatureView(View):
    ...
    def get(self, request, *args, **kwargs):
        categories = CategoryProduct.objects.all()
        context = {'categories': categories}
        return render(request, 'specification/new_product_feature.html', context)
...
class AttachNewFeatureToProduct(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        option = '<option value="{value}">{option_name}</option>'
        html_select = """<select class="form-select" name="product-category-features" 
        id="product-category-features-id" aria-label="Default select example"> <option selected>---</option> {result} 
        </select> """
...
class ProductFeatureChoicesAjaxView(View):
    ...
    def get(self, request, *args, **kwargs):
        res_string = ""
        category = CategoryProduct.objects.get(id=int(request.GET.get('category_id')))
        ...
        option = '<option value="{value}">{option_name}</option>'
        html_select = """<select class="form-select" name="product-category-features-choices" 
        id="product-category-features-choices-id" aria-label="Default select example"> <option selected>---</option> 
        {result} </select> """
...
class UpdateProductFeaturesView(View):
    ...
    def get(self, request, *args, **kwargs):
        categories = CategoryProduct.objects.all()
        context = {'categories': categories}
        return render(request, 'specification/update_product_features.html', context)
